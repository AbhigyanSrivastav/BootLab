    ...
    <section className="flex min-h-[75vh] h-[70vh] w-full max-w-6xl mx-auto flex-col items-center justify-center gap-8 p-8 text-center">
      <div className="relative">
        ...
        <div className="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl border border-white/20 rounded-3xl p-12 shadow-2xl">
          ...
          <h1 className="text-4xl md:text-6xl font-black tracking-tight bg-gradient-to-r from-white via-blue-100 to-blue-200 bg-clip-text text-transparent mb-6">
            Flexible Cloud Environments for Every Workflow
          </h1>

          <p className="text-lg md:text-xl text-gray-200 max-w-2xl mx-auto mb-8 leading-relaxed">
            A powerful cloud platform to run browsers, operating systems,
            developer tools, and even games — all with one click. Instant,
            secure, and performance-optimized for every use case.
          </p>
